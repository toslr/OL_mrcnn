...
3. download the model weights here_ and place them in the folder ``/logs``. These contain the original weights (trained on COCO dataset) and the weights trained on a custom dataset.
