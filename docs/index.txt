...
Launch the Fiji plugin. A window should pop.
...
- Choose if you want to preprocess your images. The model can run only from tiff images, the preprocessing will convert the images to tiff.
- Choose whether you want to visualize and edit the results, and if you want to save the crops.
- Finish.
