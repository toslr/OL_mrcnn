...
def main():
    ...
    ##parser.add_argument('--mod', type=bool, default=True, help='Whether to modify the images when cropping')
    ...
    for image_path in image_paths:
        ...
        r = macro_results[0]
        res_list = crop_from_results(image_path, original_img, RESULTS_DIR, macro_results, res_list, dataset_val.class_names, modify_results=True, save_images= args.save)
